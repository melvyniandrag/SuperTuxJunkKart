EVENTS = {
        ...
        (0, "BTN_PINKIE", 0):  "0EU", # A up
        (0, "BTN_PINKIE", 1):  "0ED", # A downa
        (0, "BTN_THUMB2", 0):  "0FU", # A up
        (0, "BTN_THUMB2", 1):  "0FD", # A downa
        ...
        (1, "BTN_PINKIE", 0):  "1EU", # A up
        (1, "BTN_PINKIE", 1):  "1ED", # A downa
        (1, "BTN_THUMB2", 0):  "1FU", # A up
        (1, "BTN_THUMB2", 1):  "1FD", # A downa
        ...
        (2, "BTN_PINKIE", 0):  "2EU", # A up
        (2, "BTN_PINKIE", 1):  "2ED", # A downa
        (2, "BTN_THUMB2", 0):  "2FU", # A up
        (2, "BTN_THUMB2", 1):  "2FD", # A downa
        ...
        (3, "BTN_PINKIE", 0):  "3EU", # A up
        (3, "BTN_PINKIE", 1):  "3ED", # A downa
        (3, "BTN_THUMB2", 0):  "3FU", # A up
        (3, "BTN_THUMB2", 1):  "3FD", # A downa
}
